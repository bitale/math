...
exports.differentialEquationsLessons = void 0;
exports.differentialEquationsLessons = [
    {
        "id": 65,
        "title": "미분방정식 입문",
        "category": "미분방정식",
    ...
    },
    {
        ...
        "problems": [
            ...
            },
            {
                ...
                "explanation": "시스템은 $x'=y$, $y'=-x$입니다. 따라서 $(x^2+y^2)' = 2xx' + 2yy' = 2xy - 2xy = 0$이므로 $x^2+y^2$가 일정합니다. 원점에서의 거리가 보존되므로 궤적은 원입니다.",
                "wrongAnalysis": "쌍곡선은 보통 한 방향은 커지고 다른 방향은 줄어드는 안장점에서 나타납니다. 여기서는 에너지 $x^2+y^2$가 보존되므로 원 궤적입니다."
            },
            {
                "id": "68-3",
                "type": "choice",
