...
exports.engPreschoolAge7Lessons = void 0;
exports.engPreschoolAge7Lessons = [
    // ────────────────────────────────────────────
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            ...
            intuition: "한국어로 '하나, 둘, 셋...'하고 세는 것처럼, 영어로는 'One, Two, Three...'라고 세요! 숫자를 영어로 세는 것은 아주 유용한 능력이에요.",
            formula: "1 = One (원)\n2 = Two (투)\n3 = Three (쓰리)\n4 = Four (포)\n5 = Five (파이브)\n6 = Six (식스)\n7 = Seven (세븐)\n8 = Eight (에잇)\n9 = Nine (나인)\n10 = Ten (텐)",
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            intro: "일주일은 7일이에요! 영어로 요일 이름을 알아봐요.\n\n:::note[기억해요!]\n월요일 = Monday, 화요일 = Tuesday, 수요일 = Wednesday\n목요일 = Thursday, 금요일 = Friday\n토요일 = Saturday, 일요일 = Sunday\n:::\n\n영어 요일은 모두 'day'로 끝나요! 📅",
            intuition: "일주일은 7일이에요. 학교 가는 날(Monday~Friday)과 쉬는 날(Saturday, Sunday)이 있어요. 모든 영어 요일은 'day(날)'로 끝난다는 공통점이 있어요!",
            formula: "📅 월요일 = Monday (먼데이)\n📅 화요일 = Tuesday (튜즈데이)\n📅 수요일 = Wednesday (웬즈데이)\n📅 목요일 = Thursday (써즈데이)\n📅 금요일 = Friday (프라이데이)\n📅 토요일 = Saturday (새터데이)\n📅 일요일 = Sunday (선데이)",
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            ...
            intuition: "코끼리는 크니까 Big, 생쥐는 작으니까 Small이에요! 여름의 태양은 Hot, 겨울의 눈은 Cold! 반대말을 짝으로 기억하면 한 번에 두 단어를 배울 수 있어요.",
            formula: "🐘 크다 = Big ↔ 🐭 작다 = Small\n🔥 뜨겁다 = Hot ↔ ❄️ 차갑다 = Cold\n⬆️ 위 = Up ↔ ⬇️ 아래 = Down\n😊 행복한 = Happy ↔ 😢 슬픈 = Sad",
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            intro: "지금까지 배운 숫자, 요일, 반대말을 모두 활용하는 어려운 문제에 도전해 봐요!\n\n:::note[기억해요!]\n여러 가지를 한꺼번에 생각하면 영어 실력이 쑥쑥 올라가요!\n:::\n\n잘 생각하고 꼼꼼히 풀어 봐요!",
            intuition: "숫자(One~Ten), 요일(Monday~Sunday), 반대말(Big↔Small, Hot↔Cold)을 모두 기억하고 있나요? 이것들을 함께 사용하는 연습을 하면 영어가 더 자연스러워져요!",
