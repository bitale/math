...
exports.engPreschoolAge5Lessons = void 0;
exports.engPreschoolAge5Lessons = [
    // ────────────────────────────────────────────
    // Lesson 1: 알파벳 A-F 인식
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            intro: "영어에는 알파벳이라는 글자가 있어요!\n\n오늘은 처음 여섯 글자를 배워 볼 거예요.\n\n:::note[기억해요!]\nA, B, C, D, E, F — 순서대로 외워 봐요!\n:::\n\n🍎 A는 Apple(사과), 🐻 B는 Bear(곰), 🐱 C는 Cat(고양이)으로 시작해요!",
            intuition: "노래로 불러 본 적 있죠? '에이, 비, 씨, 디, 이, 에프~' 알파벳 노래의 첫 부분이에요! 각 글자에는 친구 같은 단어가 있어요.",
            formula: "A — Apple 🍎\nB — Bear 🐻\nC — Cat 🐱\nD — Dog 🐶\nE — Egg 🥚\nF — Fish 🐟",
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            intro: "우리 주변에는 알록달록한 색깔이 가득해요!\n\n오늘은 네 가지 색깔의 영어 이름을 배워 볼 거예요.\n\n:::note[기억해요!]\n🔴 Red(빨강), 🔵 Blue(파랑), 🟡 Yellow(노랑), 🟢 Green(초록)\n:::\n\n좋아하는 색깔의 영어 이름을 기억해 봐요!",
            intuition: "신호등을 본 적 있죠? 빨간 불은 Red, 초록 불은 Green이에요! 하늘은 Blue, 바나나는 Yellow예요. 이렇게 주변 물건의 색깔로 영어를 배워요.",
            formula: "🔴 빨강 = Red\n🔵 파랑 = Blue\n🟡 노랑 = Yellow\n🟢 초록 = Green",
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            intro: "동물 친구들의 영어 이름을 알아봐요!\n\n:::note[기억해요!]\n🐱 Cat(고양이), 🐶 Dog(강아지), 🐦 Bird(새), 🐟 Fish(물고기)\n:::\n\n동물원이나 집에서 만나는 동물들의 영어 이름을 함께 배워 봐요!",
            intuition: "집에서 키우는 반려동물을 생각해 봐요! 고양이는 Cat, 강아지는 Dog이에요. 하늘을 나는 새는 Bird, 물속에 사는 물고기는 Fish예요!",
            formula: "🐱 고양이 = Cat\n🐶 강아지 = Dog\n🐦 새 = Bird\n🐟 물고기 = Fish",
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            intro: "영어에는 비슷하게 생겼거나 소리가 비슷한 단어들이 있어요!\n\n:::note[기억해요!]\n비슷한 단어를 잘 구별하면 영어 실력이 쑥쑥 올라가요!\n:::\n\n오늘은 헷갈리기 쉬운 단어들을 모아서 도전해 볼 거예요!",
            intuition: "b와 d, p와 q처럼 비슷하게 생긴 글자들이 있어요. 또 cat과 cap, dog과 dig처럼 한 글자만 달라도 뜻이 완전히 달라져요. 잘 구별하는 연습을 해 봐요!",
            formula: "비슷한 단어 구별하기:\ncat(고양이) vs cap(모자)\ndog(강아지) vs dig(파다)\nbed(침대) vs bad(나쁜)\nred(빨강) vs rod(막대기)",
