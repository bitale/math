...
exports.engPreschoolAge6Lessons = void 0;
exports.engPreschoolAge6Lessons = [
    // ────────────────────────────────────────────
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            intro: "맛있는 과일의 영어 이름을 알아봐요!\n\n:::note[기억해요!]\n🍎 Apple(사과), 🍌 Banana(바나나), 🍇 Grape(포도), 🍊 Orange(오렌지)\n:::\n\n과일 가게에 가면 이 과일들을 영어로 말해 봐요!",
            intuition: "간식으로 먹는 과일들! 사과는 Apple, 바나나는 Banana예요. '바나나'는 한국어랑 영어 발음이 비슷하죠? 포도는 Grape, 오렌지도 한국어에서 이미 쓰고 있는 말이에요!",
            formula: "🍎 사과 = Apple\n🍌 바나나 = Banana\n🍇 포도 = Grape\n🍊 오렌지 = Orange",
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            intro: "우리 몸의 이름을 영어로 알아봐요!\n\n:::note[기억해요!]\n👤 Head(머리), ✋ Hand(손), 👁️ Eye(눈), 👄 Mouth(입)\n:::\n\n'Head, Shoulders, Knees and Toes' 노래 알죠? 오늘은 우리 몸의 영어 이름을 배워요!",
            intuition: "머리를 만지면서 'Head!', 손을 흔들면서 'Hand!', 눈을 가리키면서 'Eye!', 입을 가리키면서 'Mouth!'라고 말해 봐요. 몸으로 하면 더 잘 기억나요!",
            formula: "👤 머리 = Head\n✋ 손 = Hand\n👁️ 눈 = Eye\n👄 입 = Mouth",
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            intro: "영어로 인사하는 법을 배워 봐요!\n\n:::note[기억해요!]\n👋 Hello(안녕), 👋 Goodbye(잘 가), 🙏 Thank you(고마워), 😔 Sorry(미안해)\n:::\n\n친구를 만나면 'Hello!', 헤어질 때는 'Goodbye!'라고 말해요!",
            intuition: "아침에 친구를 만나면 '안녕!' 하죠? 영어로는 'Hello!'라고 해요. 헤어질 때는 'Goodbye!', 선물을 받으면 'Thank you!', 실수했을 때는 'Sorry!'라고 말해요.",
            formula: "👋 안녕 = Hello\n👋 잘 가 = Goodbye\n🙏 고마워 = Thank you\n😔 미안해 = Sorry",
    ...
    // ────────────────────────────────────────────
    {
        ...
        concept: {
            intro: "영어에는 비슷해 보이지만 뜻이 다른 단어들이 많아요!\n\n:::note[기억해요!]\n비슷한 단어를 잘 구별하면 영어 실력이 쑥쑥 올라가요!\n:::\n\n과일, 몸, 인사 표현에서 헷갈리기 쉬운 것들을 도전해 봐요!",
            intuition: "Apple과 Orange는 둘 다 과일이지만 모양과 색이 다르죠? 영어 단어도 비슷해 보이지만 뜻이 다른 것들이 있어요. 잘 구별하는 연습을 해 봐요!",
